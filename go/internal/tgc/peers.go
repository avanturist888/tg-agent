...
// PeerCache — access_hash пользователей и каналов (data/go-peers.json).
//
// Без access_hash Telegram не даёт обратиться к пользователю или каналу по
// id. Telethon хранил их в своей SQLite-сессии, здесь — отдельным файлом.
...
// MarkedID — id в формате Bot API/Telethon: -100… для каналов, -… для групп.
...
// MarkedPeerID — id пира в формате Telethon (-100… для каналов).
