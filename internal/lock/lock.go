// Package lock — межпроцессные локи на файлах.
//
// Лок — это файл <path>.lock, созданный с O_EXCL; внутри {"pid": …, "ts": …}.
// Процессов много (MCP-сервер на каждую сессию Claude Code, слушатель, CLI,
// окно), а сессия Telegram и файлы в data/ — общие.
package lock
